...
//            kernel = new StandardKernel(new SimpleLoggingModule());
//
...
//            namedEngine.RunProcess();
            ...
            kernel = new StandardKernel(new PropertyInjectionLoggingModule());

            simpleEngine = kernel.Get<EngineWithTwoLoggers>();
            simpleEngine.RunProcess();
